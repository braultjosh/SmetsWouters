...
var eqs; stderr 0.41;
var em; stderr 0.21;
var epinf; stderr 0.15;
var ew; stderr 0.30;
end;

//shocks;
//var ea; stderr 0.35^2;
//var eb; stderr 1.75^2;
//var eg; stderr 0.55^2;
//var eqs; stderr 0.5^2;
//var em; stderr 0.2^2;
//var epinf; stderr 0.12^2;
//var ew; stderr 0.23^2;
//end;
...
stderr eb,1.1818513,0.025,5,INV_GAMMA_PDF,0.1,2;
...
cmap,.5,0.01,.9999,BETA_PDF,0.5,0.2;
cmaw,.5,0.01,.9999,BETA_PDF,0.5,0.2;
csadjcost,5,2,15,NORMAL_PDF,4,1.5;
csigma,1.5,0.25,3,NORMAL_PDF,1.50,0.375;
chabb,0.7205,0.001,0.99,BETA_PDF,0.7,0.1;
cprobw,0.7937,0.3,0.95,BETA_PDF,0.5,0.1;
csigl,1.8,0.25,10,NORMAL_PDF,2,0.75;
...
cgy,0.25,0.01,2.0,NORMAL_PDF,0.5,0.25;
...
stoch_simul(order = 1, periods = 1000, nograph, irf = 0) dy dc dinve labobs pinfobs dw robs;
//save simulation_data_wrong dy dc dinve labobs pinfobs dw robs
//estimation(datafile = simulation_data, mh_replic=50000, mh_nblocks = 1, mh_drop = 0.25, mh_jscale=0.4, nograph, mode_compute=6);
